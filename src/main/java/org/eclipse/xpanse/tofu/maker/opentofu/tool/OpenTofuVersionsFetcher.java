...
public class OpenTofuVersionsFetcher {
    ...
    public Set<String> fetchAvailableVersionsFromOpenTofuWebsite() throws Exception {
        ...
        log.info(
                "Start to fetch available versions from website for OpenTofu." + " Retry count: {}",
                retryCount);
        ...
        try {
            ...
            log.error(
                    "Failed to fetch available versions from OpenTofu website. Retry count: {}",
                    retryCount,
                    e);
            throw e;
        }
        log.info(
                "Get available versions: {} from OpenTofu website. Retry count: {}",
                allVersions,
                retryCount);
    ...
    public Set<String> getDefaultVersionsFromConfig() {
        ...
        log.info(
                "Get default versions: {} from OpenTofu versions config value: {}",
                defaultVersions,
